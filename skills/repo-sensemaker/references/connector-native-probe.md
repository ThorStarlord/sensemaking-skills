...
3. **Pin file evidence.** For every file used as decision-changing evidence, preserve the repository path, GitHub-supplied blob SHA, and the smallest relevant line range. A default-branch read is not equivalent evidence.
