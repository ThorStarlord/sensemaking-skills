...
| `discovery_confidence` | **Keep, as-is** | Formalizes an already-evidenced pre-vNext practice (S1's own "confidence and why bounded" prose). Its low-confidence path is untested, not unsupported — cheap to keep, real prior-art behind it. |
