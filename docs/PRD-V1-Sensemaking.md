...
> product-thesis authority is `docs/product-strategy.md`; current repository
> state is `STATUS.md`; the current product boundary is
> `docs/adr/0029-current-product-boundary.md`; operator/release qualification
> authority is `docs/operations-runbook.md` plus checked-in CI workflows.
>
