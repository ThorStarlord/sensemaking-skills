...
PERMITTED_RUN_CONTROL_FILES = frozenset(
    {
        ...
        # Historical PR #113 approval, relocated out of the active-approval
        # path after the artifact-root topology (PR #114) forced a record
        # regeneration and invalidated its digest binding. Not
        # `owner-approval.md`; Gate A never reads it.
