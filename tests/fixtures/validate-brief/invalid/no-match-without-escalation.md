...
---
# Example: Repository Sensemaking Brief — null workflow id WITHOUT escalation
...
A null workflow id without escalation is not a truthful no-match state: the brief neither names a workflow nor signals why. Logic trace: the contract requires either a valid registry workflow id or an escalation-recommended no-match state; this fixture has neither.

## 10. Candidate next steps
1. Create a `shared-vocabulary.md` reference.

## 11. Recommended next step
Name a supported workflow or escalate.
