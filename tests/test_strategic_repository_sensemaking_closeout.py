...
def test_status_is_terminal_for_issue_401_and_preserves_policy_hierarchy() -> None:
    ...
    assert "ADAPTIVE_POLICY_COORDINATOR_STATUS = AUTHORIZED_NOT_SELECTED_BY_THIS_CLOSEOUT" in status
    ...
    assert "Inquiry, Metareasoning, Exploration, Warrant / Choice, Learning / Reconciliation" in status
