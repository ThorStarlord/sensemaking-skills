...
### Changed
- **Final Version 1.0 readiness gate repair** — makes the authoritative final-release gate mechanically satisfiable by consuming exact-head CI results, final artifact digests, and explicit release-owner authorization through provenance-bound ignored/out-of-tree sidecars; adds a positive READY regression plus stale/failed evidence rejection without freezing RC3, expanding the reduced-scope claim ceiling, or granting publication authority.
