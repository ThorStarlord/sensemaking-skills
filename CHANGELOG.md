...
### Changed
- **Value-Creation & Development Posture Reconciliation v1** — reinterprets active development around valuable, warranted progress under uncertainty: adds commission/omission/delay symmetry, lifecycle-sensitive rigor, anti-abdication guidance, open-product-evolution search over capability identity/depth/adjacency/composition/pruning/hardening, and an explicit distinction between active product evolution and intentionally entered Version 1.0 terminalization. Reuses the existing Policy Hierarchy and strategic Skills without a new runtime, lifecycle schema, score, router, or authority expansion.
