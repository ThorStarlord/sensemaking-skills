...
- preserve Inquiry Policy v0, Metareasoning Policy v0, and Exploration Policy v0 as composable semantic policies for path-distinguishing uncertainty, control-mode selection, and iterative search allocation.
