...
`development`. Release qualification remains available downstream, but RC3
freeze, final `1.0.0`, tag, PyPI publication, and other protected release
transitions are not authorized by this development-posture reinterpretation.